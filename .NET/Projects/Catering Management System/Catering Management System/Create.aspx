<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Create.aspx.vb" Inherits="Catering_Management_System.Create" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        body {
            ...
            background-color: #fff8e1; /* Updated to soft yellow background */
            display: flex;
