<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="Catering_Management_System.login" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        body {
            ...
            background-color: #fff8e1; /* Updated to light yellow background */
            display: flex;
