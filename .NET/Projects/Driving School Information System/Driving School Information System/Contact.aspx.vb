...
Public Class Contact
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ' Any necessary actions on page load
    End Sub

    Protected Sub SendButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SendButton.Click
        Try
            ' Define the connection string
            Dim connectionString As String = "Data Source=LAPTOP-SBLEMHDL\SQLEXPRESS;Initial Catalog=Driving;Integrated Security=True"
            ...
            Using con As New SqlConnection(connectionString)
                ...
                Dim query As String = "INSERT INTO ContactForm (Name, Email, Phone, Message) VALUES (@Name, @Email, @Phone, @Message)"
