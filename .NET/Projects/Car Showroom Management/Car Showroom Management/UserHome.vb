...
Public Class UserHome
    ...
    Private Sub UserHome_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'CarDataSet6.SoldOutCars' table. You can move, or remove it, as needed.
        Me.SoldOutCarsTableAdapter.Fill(Me.CarDataSet6.SoldOutCars)

        MessageBox.Show("Welcome to User Dashboard!", "User Home", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub SearchButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchButton.Click
        ...
        Dim query As String = "SELECT * FROM [Car].[dbo].[AttendanceRecords] WHERE Register = @Register"
