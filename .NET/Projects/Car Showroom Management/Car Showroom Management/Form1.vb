...
Public Class Form1
    ...
    Private Sub LoginButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LoginButton.Click
        ...
        Dim cmd As New SqlCommand("SELECT PasswordHash, Role FROM Users WHERE Username = @Username", conn)
    ...
    Private Sub CreateLinkLabel_LinkClicked(ByVal sender As Object, ByVal e As LinkLabelLinkClickedEventArgs) Handles CreateLinkLabel.LinkClicked
        Dim registerForm As New Create()
        registerForm.Show()
        Me.Hide()
    End Sub
End Class
