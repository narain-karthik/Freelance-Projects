...
Partial Public Class RestaurantDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal EmployeeID As Integer, ByVal Name As String, ByVal Role As String, ByVal Gender As String, ByVal DateOfBirth As Date, ByVal Address As String, ByVal PhoneNumber As String, ByVal DateOfJoining As Date) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {EmployeeID, Name, Role, Gender, DateOfBirth, Address, PhoneNumber, DateOfJoining}
    ...
    Partial Public Class EmployeeRow
        ...
        Public Function IsDateOfBirthNull() As Boolean
            Return Me.IsNull(Me.tableEmployee.DateOfBirthColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetDateOfBirthNull()
            Me(Me.tableEmployee.DateOfBirthColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsDateOfJoiningNull() As Boolean
            Return Me.IsNull(Me.tableEmployee.DateOfJoiningColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetDateOfJoiningNull()
            Me(Me.tableEmployee.DateOfJoiningColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@"& _ 
                ...
                "Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)) AND ((@IsNull_Gender "& _ 
                "= 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_DateOf"& _ 
                "Birth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth))"& _ 
                " AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Addr"& _ 
                "ess)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber]"& _ 
                " = @Original_PhoneNumber)) AND ((@IsNull_DateOfJoining = 1 AND [DateOfJoining] I"& _ 
                "S NULL) OR ([DateOfJoining] = @Original_DateOfJoining)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EmployeeID], [Name], [Role], [Gender], [DateOfBirt"& _ 
                "h], [Address], [PhoneNumber], [DateOfJoining]) VALUES (@EmployeeID, @Name, @Role"& _ 
                ", @Gender, @DateOfBirth, @Address, @PhoneNumber, @DateOfJoining);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Employ"& _ 
                "eeID, Name, Role, Gender, DateOfBirth, Address, PhoneNumber, DateOfJoining FROM "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [EmployeeID] = @EmployeeID, [Name] = @Name, [Role] = "& _ 
                "@Role, [Gender] = @Gender, [DateOfBirth] = @DateOfBirth, [Address] = @Address, ["& _ 
                "PhoneNumber] = @PhoneNumber, [DateOfJoining] = @DateOfJoining WHERE (([EmployeeI"& _ 
                "D] = @Original_EmployeeID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name]"& _ 
                " = @Original_Name)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Ori"& _ 
                "ginal_Role)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Orig"& _ 
                "inal_Gender)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([Date"& _ 
                "OfBirth] = @Original_DateOfBirth)) AND ((@IsNull_Address = 1 AND [Address] IS NU"& _ 
                "LL) OR ([Address] = @Original_Address)) AND ((@IsNull_PhoneNumber = 1 AND [Phone"& _ 
                "Number] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_DateO"& _ 
                "fJoining = 1 AND [DateOfJoining] IS NULL) OR ([DateOfJoining] = @Original_DateOf"& _ 
                "Joining)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, Name, Role, Gender, DateOfBirth, Address, PhoneN"& _ 
                "umber, DateOfJoining FROM Employee WHERE (EmployeeID = @EmployeeID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EmployeeID, Name, Role, Gender, DateOfBirth, Address, PhoneNumber, DateOfJ"& _ 
                "oining FROM dbo.Employee"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As RestaurantDataSet.EmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As RestaurantDataSet.EmployeeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As RestaurantDataSet.EmployeeDataTable = New RestaurantDataSet.EmployeeDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As RestaurantDataSet.EmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_Name As String, ByVal Original_Role As String, ByVal Original_Gender As String, ByVal Original_DateOfBirth As Global.System.Nullable(Of Date), ByVal Original_Address As String, ByVal Original_PhoneNumber As String, ByVal Original_DateOfJoining As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_DateOfJoining.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_DateOfJoining.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal EmployeeID As Integer, ByVal Name As String, ByVal Role As String, ByVal Gender As String, ByVal DateOfBirth As Global.System.Nullable(Of Date), ByVal Address As String, ByVal PhoneNumber As String, ByVal DateOfJoining As Global.System.Nullable(Of Date)) As Integer
            ...
            If (DateOfJoining.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(DateOfJoining.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_DateOfJoining As Global.System.Nullable(Of Date)) As Integer
            ...
            End If
            If (DateOfJoining.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(DateOfJoining.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Role As String, ByVal Gender As String, ByVal DateOfBirth As Global.System.Nullable(Of Date), ByVal Address As String, ByVal PhoneNumber As String, ByVal DateOfJoining As Global.System.Nullable(Of Date), ByVal Original_EmployeeID As Integer, ByVal Original_Name As String, ByVal Original_Role As String, ByVal Original_Gender As String, ByVal Original_DateOfBirth As Global.System.Nullable(Of Date), ByVal Original_Address As String, ByVal Original_PhoneNumber As String, ByVal Original_DateOfJoining As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(Original_EmployeeID, Name, Role, Gender, DateOfBirth, Address, PhoneNumber, DateOfJoining, Original_EmployeeID, Original_Name, Original_Role, Original_Gender, Original_DateOfBirth, Original_Address, Original_PhoneNumber, Original_DateOfJoining)
        End Function
    End Class
