...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("WoodDataSet1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class WoodDataSet1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As WoodDataSet1 = CType(MyBase.Clone,WoodDataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "WoodDataSet1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/WoodDataSet1.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As WoodDataSet1 = New WoodDataSet1()
    ...
    Partial Public Class SupplierDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSupplierRow(ByVal SupplierCode As String, ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal ItemCode As String) As SupplierRow
            Dim rowSupplierRow As SupplierRow = CType(Me.NewRow,SupplierRow)
            Dim columnValuesArray() As Object = New Object() {SupplierCode, SupplierName, PhoneNumber, Address, ItemCode}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindBySupplierCode(ByVal SupplierCode As String) As SupplierRow
            Return CType(Me.Rows.Find(New Object() {SupplierCode}),SupplierRow)
        End Function
    ...
    Partial Public Class SupplierRow
        ...
        Public Property ItemCode() As String
            Get
                Try 
                    Return CType(Me(Me.tableSupplier.ItemCodeColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ItemCode' in table 'Supplier' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSupplier.ItemCodeColumn) = value
            End Set
        End Property
        ...
        Public Function IsPhoneNumberNull() As Boolean
            Return Me.IsNull(Me.tableSupplier.PhoneNumberColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetPhoneNumberNull()
            Me(Me.tableSupplier.PhoneNumberColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsItemCodeNull() As Boolean
            Return Me.IsNull(Me.tableSupplier.ItemCodeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetItemCodeNull()
            Me(Me.tableSupplier.ItemCodeColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace WoodDataSet1TableAdapters
    ...
    Partial Public Class SupplierTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Supplier] WHERE (([SupplierCode] = @Original_SupplierCode) AND"& _ 
                " ((@IsNull_SupplierName = 1 AND [SupplierName] IS NULL) OR ([SupplierName] = @Or"& _ 
                "iginal_SupplierName)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) O"& _ 
                "R ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Address = 1 AND [Addres"& _ 
                "s] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_ItemCode = 1 AND ["& _ 
                "ItemCode] IS NULL) OR ([ItemCode] = @Original_ItemCode)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Supplier] ([SupplierCode], [SupplierName], [PhoneNumber], [Add"& _ 
                "ress], [ItemCode]) VALUES (@SupplierCode, @SupplierName, @PhoneNumber, @Address,"& _ 
                " @ItemCode);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierCode, SupplierName, PhoneNumber, Address, ItemCode "& _ 
                "FROM Supplier WHERE (SupplierCode = @SupplierCode)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Supplier] SET [SupplierCode] = @SupplierCode, [SupplierName] = @Sup"& _ 
                "plierName, [PhoneNumber] = @PhoneNumber, [Address] = @Address, [ItemCode] = @Ite"& _ 
                "mCode WHERE (([SupplierCode] = @Original_SupplierCode) AND ((@IsNull_SupplierNam"& _ 
                "e = 1 AND [SupplierName] IS NULL) OR ([SupplierName] = @Original_SupplierName)) "& _ 
                "AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Or"& _ 
                "iginal_PhoneNumber)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Addre"& _ 
                "ss] = @Original_Address)) AND ((@IsNull_ItemCode = 1 AND [ItemCode] IS NULL) OR "& _ 
                "([ItemCode] = @Original_ItemCode)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierCode, SupplierName, PhoneNu"& _ 
                "mber, Address, ItemCode FROM Supplier WHERE (SupplierCode = @SupplierCode)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierCode, SupplierName, PhoneNumber, Address, ItemCode FROM dbo.Suppli"& _ 
                "er"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As WoodDataSet1.SupplierDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As WoodDataSet1.SupplierDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As WoodDataSet1.SupplierDataTable = New WoodDataSet1.SupplierDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As WoodDataSet1.SupplierDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As WoodDataSet1) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SupplierCode As String, ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String, ByVal Original_ItemCode As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_ItemCode,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal SupplierCode As String, ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal ItemCode As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal SupplierCode As String, ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal ItemCode As String, ByVal Original_SupplierCode As String, ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String, ByVal Original_ItemCode As String) As Integer
            If (SupplierCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SupplierCode")
            Else
            ...
            If (Original_SupplierCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SupplierCode")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_SupplierCode,String)
            End If
            If (Original_SupplierName Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal ItemCode As String, ByVal Original_SupplierCode As String, ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String, ByVal Original_ItemCode As String) As Integer
            Return Me.Update(Original_SupplierCode, SupplierName, PhoneNumber, Address, ItemCode, Original_SupplierCode, Original_SupplierName, Original_PhoneNumber, Original_Address, Original_ItemCode)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As WoodDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As WoodDataSet1, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._supplierTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As WoodDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._supplierTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As WoodDataSet1) As Integer
