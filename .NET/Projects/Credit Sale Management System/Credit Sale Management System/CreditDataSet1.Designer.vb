...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("CreditDataSet1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class CreditDataSet1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As CreditDataSet1 = CType(MyBase.Clone,CreditDataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "CreditDataSet1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/CreditDataSet1.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As CreditDataSet1 = New CreditDataSet1()
    ...
    Partial Public Class SupplierDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSupplierRow(ByVal SupplierName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date) As SupplierRow
            Dim rowSupplierRow As SupplierRow = CType(Me.NewRow,SupplierRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, SupplierName, ContactNumber, EmailID, Address, DOB, RegistrationDate}
    ...
    Partial Public Class SupplierRow
        ...
        Public Property ContactNumber() As String
            Get
                Return CType(Me(Me.tableSupplier.ContactNumberColumn),String)
            End Get
            Set
                Me(Me.tableSupplier.ContactNumberColumn) = value
            End Set
        End Property
        ...
        Public Property DOB() As Date
            Get
                Return CType(Me(Me.tableSupplier.DOBColumn),Date)
            End Get
            Set
                Me(Me.tableSupplier.DOBColumn) = value
            End Set
        End Property
        ...
        Public Property RegistrationDate() As Date
            Get
                Return CType(Me(Me.tableSupplier.RegistrationDateColumn),Date)
            End Get
            Set
                Me(Me.tableSupplier.RegistrationDateColumn) = value
            End Set
        End Property
    End Class
...
Namespace CreditDataSet1TableAdapters
    ...
    Partial Public Class SupplierTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Supplier] WHERE (([SupplierID] = @Original_SupplierID) AND ([S"& _ 
                "upplierName] = @Original_SupplierName) AND ([ContactNumber] = @Original_ContactN"& _ 
                "umber) AND ([EmailID] = @Original_EmailID) AND ([Address] = @Original_Address) A"& _ 
                "ND ([DOB] = @Original_DOB) AND ([RegistrationDate] = @Original_RegistrationDate)"& _ 
                ")"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Supplier] ([SupplierName], [ContactNumber], [EmailID], [Addres"& _ 
                "s], [DOB], [RegistrationDate]) VALUES (@SupplierName, @ContactNumber, @EmailID, "& _ 
                "@Address, @DOB, @RegistrationDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID, SupplierName, ContactNum"& _ 
                "ber, EmailID, Address, DOB, RegistrationDate FROM Supplier WHERE (SupplierID = S"& _ 
                "COPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Supplier] SET [SupplierName] = @SupplierName, [ContactNumber] = @Co"& _ 
                "ntactNumber, [EmailID] = @EmailID, [Address] = @Address, [DOB] = @DOB, [Registra"& _ 
                "tionDate] = @RegistrationDate WHERE (([SupplierID] = @Original_SupplierID) AND ("& _ 
                "[SupplierName] = @Original_SupplierName) AND ([ContactNumber] = @Original_Contac"& _ 
                "tNumber) AND ([EmailID] = @Original_EmailID) AND ([Address] = @Original_Address)"& _ 
                " AND ([DOB] = @Original_DOB) AND ([RegistrationDate] = @Original_RegistrationDat"& _ 
                "e));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID, SupplierName, ContactNumber, EmailID, Address, DOB, Reg"& _ 
                "istrationDate FROM Supplier WHERE (SupplierID = @SupplierID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierID, SupplierName, ContactNumber, EmailID, Address, DOB, Registrati"& _ 
                "onDate FROM dbo.Supplier"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As CreditDataSet1.SupplierDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As CreditDataSet1.SupplierDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As CreditDataSet1.SupplierDataTable = New CreditDataSet1.SupplierDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As CreditDataSet1.SupplierDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As CreditDataSet1) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SupplierID As Integer, ByVal Original_SupplierName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_ContactNumber,String)
            End If
            ...
            Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_RegistrationDate,Date)
        ...
        Public Overloads Overridable Function Insert(ByVal SupplierName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(5).Value = CType(RegistrationDate,Date)
        ...
        Public Overloads Overridable Function Update(ByVal SupplierName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date, ByVal Original_SupplierID As Integer, ByVal Original_SupplierName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date, ByVal SupplierID As Integer) As Integer
            If (SupplierName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SupplierName")
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(RegistrationDate,Date)
            ...
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_RegistrationDate,Date)
            Me.Adapter.UpdateCommand.Parameters(13).Value = CType(SupplierID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal SupplierName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date, ByVal Original_SupplierID As Integer, ByVal Original_SupplierName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date) As Integer
            Return Me.Update(SupplierName, ContactNumber, EmailID, Address, DOB, RegistrationDate, Original_SupplierID, Original_SupplierName, Original_ContactNumber, Original_EmailID, Original_Address, Original_DOB, Original_RegistrationDate, Original_SupplierID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As CreditDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As CreditDataSet1, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._supplierTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As CreditDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._supplierTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As CreditDataSet1) As Integer
