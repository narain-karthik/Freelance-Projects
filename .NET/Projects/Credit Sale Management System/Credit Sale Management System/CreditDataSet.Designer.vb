...
Partial Public Class CreditDataSet
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal CustomerName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CustomerName, ContactNumber, EmailID, Address, DOB, RegistrationDate}
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([CustomerID] = @Original_CustomerID) AND ([C"& _ 
                "ustomerName] = @Original_CustomerName) AND ([ContactNumber] = @Original_ContactN"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([CustomerName], [ContactNumber], [EmailID], [Addres"& _ 
                "s], [DOB], [RegistrationDate]) VALUES (@CustomerName, @ContactNumber, @EmailID, "& _ 
                "@Address, @DOB, @RegistrationDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, CustomerName, ContactNum"& _ 
                "ber, EmailID, Address, DOB, RegistrationDate FROM Customer WHERE (CustomerID = S"& _ 
                "COPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [CustomerName] = @CustomerName, [ContactNumber] = @Co"& _ 
                "ntactNumber, [EmailID] = @EmailID, [Address] = @Address, [DOB] = @DOB, [Registra"& _ 
                "tionDate] = @RegistrationDate WHERE (([CustomerID] = @Original_CustomerID) AND ("& _ 
                "[CustomerName] = @Original_CustomerName) AND ([ContactNumber] = @Original_Contac"& _ 
                ...
                "e));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, CustomerName, ContactNumber, EmailID, Address, DOB, Reg"& _ 
                "istrationDate FROM Customer WHERE (CustomerID = @CustomerID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CustomerID, CustomerName, ContactNumber, EmailID, Address, DOB, Registrati"& _ 
                "onDate FROM dbo.Customer"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As CreditDataSet.CustomerDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As CreditDataSet.CustomerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As CreditDataSet.CustomerDataTable = New CreditDataSet.CustomerDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As CreditDataSet.CustomerDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As CreditDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerID As Integer, ByVal Original_CustomerName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal CustomerName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date, ByVal Original_CustomerID As Integer, ByVal Original_CustomerName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date, ByVal CustomerID As Integer) As Integer
            If (CustomerName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CustomerName")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CustomerName As String, ByVal ContactNumber As String, ByVal EmailID As String, ByVal Address As String, ByVal DOB As Date, ByVal RegistrationDate As Date, ByVal Original_CustomerID As Integer, ByVal Original_CustomerName As String, ByVal Original_ContactNumber As String, ByVal Original_EmailID As String, ByVal Original_Address As String, ByVal Original_DOB As Date, ByVal Original_RegistrationDate As Date) As Integer
            Return Me.Update(CustomerName, ContactNumber, EmailID, Address, DOB, RegistrationDate, Original_CustomerID, Original_CustomerName, Original_ContactNumber, Original_EmailID, Original_Address, Original_DOB, Original_RegistrationDate, Original_CustomerID)
        End Function
    End Class
