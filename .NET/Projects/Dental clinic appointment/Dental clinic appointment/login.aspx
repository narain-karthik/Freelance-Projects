<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="Dental_clinic_appointment.login" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        body {
            ...
            background-color: #fafafa; /* Updated to light yellow background */
            display: flex;
        ...
        input[type="password"] {
            ...
            background-color: #fafafa1; /* Light yellow background */
            font-size: 16px;
            color: #333;
        }
