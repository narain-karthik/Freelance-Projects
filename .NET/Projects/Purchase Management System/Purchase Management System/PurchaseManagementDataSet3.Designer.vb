...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("PurchaseManagementDataSet3"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class PurchaseManagementDataSet3
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As PurchaseManagementDataSet3 = CType(MyBase.Clone,PurchaseManagementDataSet3)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "PurchaseManagementDataSet3"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/PurchaseManagementDataSet3.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As PurchaseManagementDataSet3 = New PurchaseManagementDataSet3()
    ...
    Partial Public Class EmployeesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeesRow(ByVal EmployeeCode As String, ByVal EmployeeName As String, ByVal ContactNumber As String, ByVal Address As String, ByVal Salary As Decimal, ByVal DateOfBirth As Date, ByVal Gender As String, ByVal Position As String, ByVal DateOfJoining As Date) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, EmployeeCode, EmployeeName, ContactNumber, Address, Salary, DateOfBirth, Gender, Position, DateOfJoining}
...
Namespace PurchaseManagementDataSet3TableAdapters
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND (["& _ 
                "EmployeeCode] = @Original_EmployeeCode) AND ([EmployeeName] = @Original_Employee"& _ 
                "Name) AND ([ContactNumber] = @Original_ContactNumber) AND ((@IsNull_Address = 1 "& _ 
                "AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([Salary] = @Orig"& _ 
                "inal_Salary) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([Gender] = @Origin"& _ 
                "al_Gender) AND ([Position] = @Original_Position) AND ([DateOfJoining] = @Origina"& _ 
                "l_DateOfJoining))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmployeeCode], [EmployeeName], [ContactNumber], ["& _ 
                "Address], [Salary], [DateOfBirth], [Gender], [Position], [DateOfJoining]) VALUES"& _ 
                " (@EmployeeCode, @EmployeeName, @ContactNumber, @Address, @Salary, @DateOfBirth,"& _ 
                " @Gender, @Position, @DateOfJoining);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, EmployeeCode, Employee"& _ 
                "Name, ContactNumber, Address, Salary, DateOfBirth, Gender, Position, DateOfJoini"& _ 
                "ng FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [EmployeeCode] = @EmployeeCode, [EmployeeName] = @Em"& _ 
                ...
                "Salary, [DateOfBirth] = @DateOfBirth, [Gender] = @Gender, [Position] = @Position"& _ 
                ", [DateOfJoining] = @DateOfJoining WHERE (([EmployeeID] = @Original_EmployeeID) "& _ 
                "AND ([EmployeeCode] = @Original_EmployeeCode) AND ([EmployeeName] = @Original_Em"& _ 
                "ployeeName) AND ([ContactNumber] = @Original_ContactNumber) AND ((@IsNull_Addres"& _ 
                "s = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([Salary] ="& _ 
                " @Original_Salary) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([Gender] = @"& _ 
                "Original_Gender) AND ([Position] = @Original_Position) AND ([DateOfJoining] = @O"& _ 
                "riginal_DateOfJoining));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, EmployeeCode, EmployeeName, Contact"& _ 
                "Number, Address, Salary, DateOfBirth, Gender, Position, DateOfJoining FROM Emplo"& _ 
                "yees WHERE (EmployeeID = @EmployeeID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EmployeeID, EmployeeCode, EmployeeName, ContactNumber, Address, Salary, Da"& _ 
                "teOfBirth, Gender, Position, DateOfJoining FROM dbo.Employees"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As PurchaseManagementDataSet3.EmployeesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As PurchaseManagementDataSet3.EmployeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As PurchaseManagementDataSet3.EmployeesDataTable = New PurchaseManagementDataSet3.EmployeesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As PurchaseManagementDataSet3.EmployeesDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As PurchaseManagementDataSet3) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_EmployeeCode As String, ByVal Original_EmployeeName As String, ByVal Original_ContactNumber As String, ByVal Original_Address As String, ByVal Original_Salary As Decimal, ByVal Original_DateOfBirth As Date, ByVal Original_Gender As String, ByVal Original_Position As String, ByVal Original_DateOfJoining As Date) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_DateOfJoining,Date)
        ...
        Public Overloads Overridable Function Insert(ByVal EmployeeCode As String, ByVal EmployeeName As String, ByVal ContactNumber As String, ByVal Address As String, ByVal Salary As Decimal, ByVal DateOfBirth As Date, ByVal Gender As String, ByVal Position As String, ByVal DateOfJoining As Date) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(8).Value = CType(DateOfJoining,Date)
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(DateOfJoining,Date)
            ...
            If (Original_EmployeeName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_EmployeeName")
            Else
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_EmployeeName,String)
            End If
            If (Original_ContactNumber Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ContactNumber")
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_ContactNumber,String)
            End If
            If (Original_Address Is Nothing) Then
            ...
            Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_DateOfBirth,Date)
            If (Original_Gender Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Gender")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_DateOfJoining,Date)
            Me.Adapter.UpdateCommand.Parameters(20).Value = CType(EmployeeID,Integer)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Gender As String,  _
                    ByVal Original_Position As String,  _
                    ByVal Original_DateOfJoining As Date) As Integer
            Return Me.Update(EmployeeCode, EmployeeName, ContactNumber, Address, Salary, DateOfBirth, Gender, Position, DateOfJoining, Original_EmployeeID, Original_EmployeeCode, Original_EmployeeName, Original_ContactNumber, Original_Address, Original_Salary, Original_DateOfBirth, Original_Gender, Original_Position, Original_DateOfJoining, Original_EmployeeID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As PurchaseManagementDataSet3, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As PurchaseManagementDataSet3, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._employeesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As PurchaseManagementDataSet3, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._employeesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As PurchaseManagementDataSet3) As Integer
