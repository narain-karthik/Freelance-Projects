...
Public Class SalesDetails
            ...
            Using con As New SqlConnection(connectionString)
                Using cmd As New SqlCommand(query, con)
                    ...
                    Try
                        ...
                        TextBoxCustomerName.Text = If(result IsNot Nothing, result.ToString(), "Customer not found")
    ...
    Private Sub ButtonAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ButtonAdd.Click
        Dim quantity As Decimal
        If String.IsNullOrEmpty(TextBoxCustomerID.Text) Then
            ...
            Using cmd As New SqlCommand(query, con)
                Try
                    ...
                    For Each row As DataGridViewRow In DataGridViewSales.Rows
                        ...
                        End If
                    Next
                    MessageBox.Show("Sales details saved successfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
