...
Public Class SalesDetails
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Try
            con.Open()
            Dim cmd As New SqlCommand("INSERT INTO SalesDetails (FruitName, Quantity, Unit, SellingPrice, CustomerName, SalesDate, Remarks) VALUES (@FruitName, @Quantity, @Unit, @SellingPrice, @CustomerName, @SalesDate, @Remarks)", con)
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            con.Open()
            Dim cmd As New SqlCommand("UPDATE SalesDetails SET FruitName=@FruitName, Quantity=@Quantity, Unit=@Unit, SellingPrice=@SellingPrice, CustomerName=@CustomerName, SalesDate=@SalesDate, Remarks=@Remarks WHERE SalesID=@SalesID", con)
            cmd.Parameters.AddWithValue("@FruitName", cmbFruitName.Text)
            cmd.Parameters.AddWithValue("@Quantity", Convert.ToInt32(txtQuantity.Text))
            cmd.Parameters.AddWithValue("@Unit", cmbUnit.Text)
            cmd.Parameters.AddWithValue("@SellingPrice", Convert.ToDecimal(txtSellingPrice.Text))
